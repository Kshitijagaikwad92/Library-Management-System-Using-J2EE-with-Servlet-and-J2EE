...
public class AddComicsBookServlet extends HttpServlet {
    public AddComicsBookServlet() {
        super();
        }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		try
		{
			...
			PreparedStatement st=con.prepareStatement("insert into comics_book values(?,?,?,?,?,?)");
