...
public class ShowHistoricalBookServlet extends HttpServlet 
{
    public ShowHistoricalBookServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
		    ...
		    ps=con.prepareStatement("select * from historical_book");
		    ResultSet rs=ps.executeQuery();
		    out.print("<html>");	
		    out.print("<body>");
		    out.print("background: linear-gradient(to left,rgba(0, 0, 0, 0.5) ,rgba(0, 0, 0, 0.5)) ,url(library.jpg) center/cover;");
