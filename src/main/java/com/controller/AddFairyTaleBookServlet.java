...
public class AddFairyTaleBookServlet extends HttpServlet {
    public AddFairyTaleBookServlet() {
        super();
        }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		try
		{
			...
			PreparedStatement st=con.prepareStatement("insert into fairy_book values(?,?,?,?,?,?)");
