...
public class AddBiographicalBookServlet extends HttpServlet {
    public AddBiographicalBookServlet() {
        super();
        }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		try
		{
			...
			PreparedStatement st=con.prepareStatement("insert into bio_book values(?,?,?,?,?,?)");
